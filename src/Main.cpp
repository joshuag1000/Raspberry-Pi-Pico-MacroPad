...
int main() {
    ...
    SetupButton(1, 0x00, 0x20, 0x00, HID_KEY_S, KEYBOARD_MODIFIER_LEFTGUI + KEYBOARD_MODIFIER_LEFTCTRL + KEYBOARD_MODIFIER_LEFTSHIFT + KEYBOARD_MODIFIER_LEFTALT, REPORT_ID_KEYBOARD);
    SetupButton(2, 0x20, 0x00, 0x20, HID_USAGE_CONSUMER_PLAY_PAUSE, 0, REPORT_ID_CONSUMER_CONTROL);
    SetupButton(3, 0x20, 0x00, 0x00, HID_KEY_DELETE, KEYBOARD_MODIFIER_LEFTCTRL + KEYBOARD_MODIFIER_LEFTALT, REPORT_ID_KEYBOARD);

    SetupButton(4, 0x20, 0x00, 0x20, HID_KEY_VOLUME_DOWN, 0, REPORT_ID_KEYBOARD);
    SetupButton(5, 0x20, 0x00, 0x00, HID_KEY_H, KEYBOARD_MODIFIER_LEFTGUI + KEYBOARD_MODIFIER_LEFTCTRL + KEYBOARD_MODIFIER_LEFTSHIFT + KEYBOARD_MODIFIER_LEFTALT, REPORT_ID_KEYBOARD);
    ...
    SetupButton(8, 0x20, 0x00, 0x20, HID_KEY_MUTE, 0, REPORT_ID_KEYBOARD);
